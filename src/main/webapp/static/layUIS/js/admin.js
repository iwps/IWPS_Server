...
layui.define(['jquery', 'form', 'layer', 'element'], function(exports) {
    ...
    $(function() {
        ...
        /**
         * 多选框，获得参数和进行删除的操作
         * @type {{init: tableCheck.init, getData: (function(): Array)}}
         */
        // tableCheck = {
        //     init: function() {
        ...
        //         //     // arr.push(obj.eq(index).attr('data-index'));
        //         //     arr.push(obj.eq(index).parentNode.parentNode.nextSibling.attr('data-field'));
        //         // });
        //         // return arr;
        //     }
        // }
